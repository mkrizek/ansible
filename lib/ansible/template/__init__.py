...
if C.DEFAULT_JINJA2_NATIVE:
    try:
        # Although Native Types were introduced in Jinja2 2.10,
        # we require 2.11+ as it includes important bugfixes.
        if LooseVersion(j2_version) < LooseVersion('2.11'):
            raise ImportError
        ...
        if C.JINJA2_NATIVE_WARNING:
            display.warning(
                'jinja2_native requires Jinja 2.11 and above. '
